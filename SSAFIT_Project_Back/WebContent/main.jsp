...
<body>
	...
	<header style="width: 1000px;"
		class="d-flex justify-content-between align-items-center m-auto">
		<img style="width: 186px; height: 48px;"
			src="./video/data/samsung_logo.PNG" alt="samsung_logo"> <img
			src="./video/data/ssafit_logo.PNG" alt="ssafit_logo">
		<div class="d-flex">
			<div class="d-flex flex-column justify-content-evenly">
				<a href="/SSAFIT_Project_Back/user/login.jsp"
					" class="btn btn-outline-secondary m-1 mx-3">log-in</a> <a
					href="/SSAFIT_Project_Back/user/signup.jsp"
					class="btn btn-outline-secondary m-1 mx-3">sign-up</a>
			</div>
...
<div class="m-3">
    <div class="d-flex justify-content-between">
        ...
        <div class="video-box">
            <iframe width="300" height="200"
                src="https://www.youtube.com/embed/swRNeYw1JkY"
                title="YouTube video player" frameborder="0"
                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                allowfullscreen></iframe>
        </div>
...
<div class="text-center mt-2">
    <a href="detail.jsp?youtubeID=gMaB-fG4u4g'" class="btn btn-primary">정보보기</a>
</div>
        <!-- 두 번째 비디오 정보보기 버튼 -->
        <div class="text-center mt-2">
            <a href="detail.jsp" class="btn btn-primary">정보보기</a>
        </div>
        <!-- 세 번째 비디오 정보보기 버튼 -->
        <div class="text-center mt-2">
            <a href="detail.jsp" class="btn btn-primary">정보보기</a>
...
<!--
		<div class="carousel-item">
			<div class="d-flex justify-content-evenly">
				<iframe width="300" height="200"
					src="https://www.youtube.com/embed/QqqZH3j_vH0"
					title="YouTube video player" frameborder="0"
					allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
					allowfullscreen></iframe>
				<iframe width="300" height="200"
					...
					allowfullscreen></iframe>
				<iframe width="300" height="200"
					src="https://www.youtube.com/embed/u5OgcZdNbMo"
					title="YouTube video player" frameborder="0"
					allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
					allowfullscreen></iframe>
			</div>
		...
		<div class="carousel-item">
			<div class="d-flex justify-content-evenly">
				...
				<iframe width="300" height="200"
					...
					allowfullscreen></iframe>
				<iframe width="300" height="200"
					src="https://www.youtube.com/embed/zruKSHfD7b4"
					title="YouTube video player" frameborder="0"
					allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
					allowfullscreen></iframe>
			</div>
	...
	<button class="carousel-control-prev" type="button"
		data-bs-target="#carouselA" data-bs-slide="prev">
		<span class="carousel-control-prev-icon" aria-hidden="true"></span> <span
			class="visually-hidden">Previous</span>
	</button>
	<button class="carousel-control-next" type="button"
		data-bs-target="#carouselA" data-bs-slide="next">
 ...
 -->
	<div style="width: 1000px;" class="m-3 border">
		...
		<div id="carouselB" class="carousel slide m-3">
			...
			<button class="carousel-control-prev" type="button"
				data-bs-target="#carouselB" data-bs-slide="prev">
				<span class="carousel-control-prev-icon" aria-hidden="true"></span>
				<span class="visually-hidden">Previous</span>
			</button>
			<button class="carousel-control-next" type="button"
				data-bs-target="#carouselB" data-bs-slide="next">
